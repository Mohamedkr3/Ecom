    ...
    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    {/* main  */}
                    <div className=" bg-blue-50 py-5 rounded-xl border border-blue-200">
                        {/* image  */}
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg"><span className=" font-bold">Name :</span> RIZK MOHAMED</h1>
                                ...
                                <div className="p-8">
                                    <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="text-sm font-medium text-gray-900">EGP 8,499</div>
                                        </div>
